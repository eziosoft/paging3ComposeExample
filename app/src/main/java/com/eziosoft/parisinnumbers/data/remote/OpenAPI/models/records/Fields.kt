...
data class Fields(
    ...
    val date_fin: String?,
    val geo_point_2d: com.eziosoft.parisinnumbers.data.remote.OpenAPI.models.records.GeoPoint2d,
    val geo_shape: com.eziosoft.parisinnumbers.data.remote.OpenAPI.models.records.GeoShape?,
    val id_lieu: String?,
